...
assert_contains "$contents_file" "./usr/share/doc/codex-ubuntu/changelog.gz"
assert_contains "$contents_file" "./usr/share/doc/codex-ubuntu/copyright"
assert_contains "$contents_file" "./usr/share/man/man1/codex-ubuntu.1.gz"
...
assert_contains "$control_file" "Depends: curl, python3, sensible-utils, xdg-utils"
assert_contains "$control_file" "Recommends: desktop-file-utils, hicolor-icon-theme, libnotify-bin"
assert_contains "$control_file" "This package installs the browser fallback and recovery launcher for Ubuntu."
